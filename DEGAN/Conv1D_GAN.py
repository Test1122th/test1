...
def get_generative(GAN_param_dic, G_in):
    ...
    x = Dense(GAN_param_dic["latent_dim"],kernel_regularizer=tf.keras.regularizers.l1(GAN_param_dic["regularization_coeff"]))(x) 
    x = Activation('tanh')(x)
    G_out = Dense(GAN_param_dic["out_dim"],
                  activation='tanh',kernel_regularizer=tf.keras.regularizers.l1(GAN_param_dic["regularization_coeff"]))(x)
    #################################################################################
...
def get_discriminative(GAN_param_dic, D_in):
    ...
    x = Reshape((-1, 1))(D_in)
    x = Conv1D(GAN_param_dic["n_channels"], GAN_param_dic["conv_sz"],
               activation='relu',kernel_regularizer=tf.keras.regularizers.l1(GAN_param_dic["regularization_coeff"]))(x)
